...
func ConnectDataBase(conn config.Postgres) (*gorm.DB, error) {
	...
	if err := db.Migrator().DropTable(&entities.Auth{}, &entities.Profile{}, &entities.Limit{}, &entities.CreditTransaction{}); err != nil {
		return nil, err
	}

	if err := db.AutoMigrate(&entities.Auth{}, &entities.Profile{}, &entities.Limit{}, &entities.CreditTransaction{}); err != nil {
		return nil, err
	}
